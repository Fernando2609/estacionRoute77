...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-05-2022 a las 10:56:04
...
(1, 'Estación Route 77', 'Ser Los Mejores De Honduras', 'Saúl Zepeda', 100, '03011972007276', 'estacionroutehn@gmail.com', 'estacionroutehn@gmail.com', '+504 22634896', '+504 9643-2601', 'Col. Los Laureles Calle Principal', '3,5,4,7', '2,6,8');
...
(33, 1, '2022-04-25 00:53:52', '1500.00', '225.00', 1, 345654);
...
(1, 'José Fernando', 'Ortiz', 'josefortizsantos@gmail.com', '65d452d53579e16d2fdf9228577b6eac314b59163f1c6ad43b61032109d3f608', 1, 1, 98912135, '', 51, '2022-02-12 02:22:51', 1, '2022-04-26 14:53:36', '2022-05-01 00:52:56'),
...
(13, 'Leonela', 'Pineda', 'lypineda@unah.hn', 'dd75ba64297196aa490cf83772f5373aa4e6ee78544374604d95ac5117d3beda', 8, 1, 97737659, '', 1, '2022-02-17 19:53:21', 1, '2022-04-24 05:06:00', '2022-04-21 20:23:01'),
...
(64, 'Gaby', 'Maradiaga', 'ggmaradiaga@unah.hn', 'dd75ba64297196aa490cf83772f5373aa4e6ee78544374604d95ac5117d3beda', 2, 1, 97514276, '', NULL, '2022-04-20 03:36:23', 1, '2022-04-20 23:34:05', '0000-00-00 00:00:00'),
...
(71, 'Juan Orlando', 'Hernandez Alvarado', 'juancito.jodido@gmail.com', 'd258729cdd62c74b34d7953995313f205f7fe9100c42aad210e088d794a3302c', 2, 1, 22668844, '', NULL, '2022-04-24 03:45:20', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
(78, 'Reynaldo', 'Giron Flores', 'reynaldo@gmail.com', 'ae528a6d8308a30428d133358cb0c053646ac189f6a2e326aeeaa7c7486fb31e', 4, 1, 87456325, '', 1, '2022-04-25 02:24:05', 1, '2022-04-25 02:43:25', '2022-04-25 02:49:30'),
...
(92, 'José Fernando', 'Santos', 'josefortizsantos2000@gmail.com', 'e60b254b88634f54d55b819de8c9018ef5deca1d5cb5aed61e45c4360db9c38c', 2, 1, 2147483647, '', NULL, '2022-04-27 03:24:16', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
--
ALTER TABLE `tbl_detalle_compra`
  MODIFY `COD_DETALLE` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DEL DETALLE DE COMPRA', AUTO_INCREMENT=45;
...
--
ALTER TABLE `tbl_orden_compra`
  MODIFY `COD_ORDEN` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DE LA ORDEN DE COMPRA', AUTO_INCREMENT=34;
...
--
ALTER TABLE `tbl_permisos`
  MODIFY `COD_PERMISO` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DE PERMISO', AUTO_INCREMENT=1381;

--
-- AUTO_INCREMENT de la tabla `tbl_personas`
--
ALTER TABLE `tbl_personas`
  MODIFY `COD_PERSONA` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DE PERSONA', AUTO_INCREMENT=93;
...
--
ALTER TABLE `tbl_redes_sociales`
  MODIFY `COD_RED_SOCIAL` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DE RED SOCIAL', AUTO_INCREMENT=14;
...
--
ALTER TABLE `tbl_sucursal`
  MODIFY `COD_SUCURSAL` int(11) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DE LA SUCURSAL', AUTO_INCREMENT=16;
...
--
ALTER TABLE `tbl_telefono_empresa`
  MODIFY `COD_TELEFONO_EMPRESA` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DEL TELÉFONO EMPRESARIAL', AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_usuarios`
  MODIFY `COD_USUARIO` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DEL USUARIO', AUTO_INCREMENT=42;
